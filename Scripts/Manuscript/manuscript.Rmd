...
As a first step it is worth investigating what the state of measurement error is in original and psychological research, in order to assess the scope of @stanley2014expectations's findings in practice. Thus, this study investigated the following:
