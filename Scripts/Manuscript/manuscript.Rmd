...
authornote: |
  ...
  complete departmental affiliations: Each new line herein must be indented, like this line.
...
This manuscript uses the Workflow for Open Reproducible Code in Science [WORCS version 0.1.1, @vanlissaWORCSWorkflowOpen2021] to ensure reproducibility and transparency. All code <!--and data--> are available at <https://github.com/CasGoos/WORCSPersonalTemplate.git>.
