...
apa_table(
  ...
  , note = "AWITHSUPERSCRIPT replication was assessed as unclear for three of the measures, since their effect was not fully replicated. These have been treated as not replicated within this table and further analyses throughout the thesis"
  , escape = TRUE, placement= "h")

### add a midrule before total
