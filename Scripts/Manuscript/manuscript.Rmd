...
```{r}
open_data(data = Data_ML1, filename = paste0(paste0(
  "Data/AnalysisData/", deparse(substitute(Data_ML1))), ".csv"),
  codebook = paste0(paste0(
    "Data/AnalysisData/codebook_", deparse(substitute(Data_ML1))), ".Rmd"),
  value_labels = paste0(paste0(
    "Data/AnalysisData/value_labels_", deparse(substitute(Data_ML1))), ".yml")) 
```
