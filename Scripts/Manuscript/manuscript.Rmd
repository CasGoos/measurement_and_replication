...
```{r Final Preparation of Data}
### this code prepares the various pieces of data to be ready to use for the analyses.
## confirmatory analyses
# for hypothesis 2
data_H2 <- data_prep_H2(coded_data_original_shortened, coded_data_replications)
# for hypothesis 5
...
# for hypothesis 3
data_H3 <- data_prep_H3(data_1.10_clean, data_1.11_clean, data_1.12.3.1_clean, 
...
# for hypothesis 4
data_H4_multiple <- Data_prep_H4_multiple(data_H5, data_H3)
data_H4_avg <- Data_prep_H4_avg(data_H5, data_H4_multiple)


## graphs
# plot accompanying the results for Hypotheses 2, 5, & 6.
plot_256_data <- data_prep_plot_256(data_H6)
# plot accompanying the results for Hypotheses 2, & 6
Plot_26_data <- data_prep_plot_26(data_H6[c(3, 6, 9, 12, 15, 36, 39, 42, 45, 48)])
# plot accompanying the results for Hypotheses 3, & 4
plot_34_data_alpha <- data_prep_plot_34_alpha(data_H4_multiple)
plot_34_data_omega <- data_prep_plot_34_omega(data_H4_multiple)
...
open_data(data = plot_256_data, filename = paste0(paste0(
  "Data/AnalysisData/", deparse(substitute(plot_256_data))), ".csv"),
  codebook = paste0(paste0(
    "Data/AnalysisData/codebook_", 
    deparse(substitute(plot_256_data))), ".Rmd"),
  value_labels = paste0(paste0(
    "Data/AnalysisData/value_labels_", 
    deparse(substitute(plot_256_data))), ".yml")) 

open_data(data = Plot_26_data, filename = paste0(paste0(
  "Data/AnalysisData/", deparse(substitute(Plot_26_data))), ".csv"),
  codebook = paste0(paste0(
    "Data/AnalysisData/codebook_", 
    deparse(substitute(Plot_26_data))), ".Rmd"),
  value_labels = paste0(paste0(
    "Data/AnalysisData/value_labels_", 
    deparse(substitute(Plot_26_data))), ".yml")) 

open_data(data = data_H3, filename = paste0(paste0(
  "Data/AnalysisData/", deparse(substitute(data_H3))), ".csv"),
  codebook = paste0(paste0(
    "Data/AnalysisData/codebook_", 
    deparse(substitute(data_H3))), ".Rmd"),
  value_labels = paste0(paste0(
    "Data/AnalysisData/value_labels_", 
    deparse(substitute(data_H3))), ".yml")) 

open_data(data = data_H4_multiple, filename = paste0(paste0(
  "Data/AnalysisData/", deparse(substitute(data_H4_multiple))), ".csv"),
  codebook = paste0(paste0(
    "Data/AnalysisData/codebook_", 
    deparse(substitute(data_H4_multiple))), ".Rmd"),
  value_labels = paste0(paste0(
    "Data/AnalysisData/value_labels_", 
    deparse(substitute(data_H4_multiple))), ".yml")) 

open_data(data = data_H4_avg, filename = paste0(paste0(
  "Data/AnalysisData/", deparse(substitute(data_H4_avg))), ".csv"),
  codebook = paste0(paste0(
    "Data/AnalysisData/codebook_", 
    deparse(substitute(data_H4_avg))), ".Rmd"),
  value_labels = paste0(paste0(
    "Data/AnalysisData/value_labels_", 
    deparse(substitute(data_H4_avg))), ".yml")) 

open_data(data = plot_34_data_alpha, filename = paste0(paste0(
  "Data/AnalysisData/", deparse(substitute(plot_34_data_alpha))), ".csv"),
  codebook = paste0(paste0(
    "Data/AnalysisData/codebook_", 
    deparse(substitute(plot_34_data_alpha))), ".Rmd"),
  value_labels = paste0(paste0(
    "Data/AnalysisData/value_labels_", 
    deparse(substitute(plot_34_data_alpha))), ".yml")) 

open_data(data = plot_34_data_omega, filename = paste0(paste0(
  "Data/AnalysisData/", deparse(substitute(plot_34_data_omega))), ".csv"),
  codebook = paste0(paste0(
    "Data/AnalysisData/codebook_", 
    deparse(substitute(plot_34_data_omega))), ".Rmd"),
  value_labels = paste0(paste0(
    "Data/AnalysisData/value_labels_", 
    deparse(substitute(plot_34_data_omega))), ".yml")) 

# clearing up memory space by removing intermediate files from the environment
rm(coded_data_original, coded_data_original_shortened, coded_data_replications)
...
H3_test_result_alpha <- summary(lmer(formula = alpha ~ 1 + (1|g), data = data_H3))

# and same analyses for omega
# intercept only model to check the within and between group variance.
H3_test_result_omega <- summary(lmer(formula = omega.tot ~ 1 + (1|g), data = data_H3[complete.cases(data_H3),]))
...
H4_test_result_main_alpha <- summary(glm(formula = replication ~ 1 + alpha_avg, 
                                     family = binomial(), data = data_H4_avg))

# and for omega
H4_test_result_main_omega <- summary(glm(formula = replication ~ 1 + 
...
H4_test_result_int_sensitivity_alpha <- summary(glmer(formula = replication ~ 1 
                                                + alpha + (1|g), family = 
                                                binomial(), data = 
                                                data_H4_multiple))

# and for omega
H4_test_result_int_sensitivity_omega <- summary(glmer(formula = replication ~ 1 
...
H4_test_result_slp_sensitivity_alpha <- summary(glmer(formula = replication ~ 1 
                                                + alpha + (1 + alpha|g), 
                                                family = binomial(), data =
                                                data_H4_multiple))

# and for omega
H4_test_result_slp_sensitivity_omega <- summary(glmer(formula = replication ~ 1 
