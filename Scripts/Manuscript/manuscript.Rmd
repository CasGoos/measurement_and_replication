...
shorttitle        : "Measurement and Replicability"
...
What materials were used (with reference)
...
```
Include also the rationale for the sample size:
...
```
And the stopping ruel, when applicable
...
We have used `r cite_r("r-references.bib")` since the pre-reg, and will use XXX for all our analyses.

## Confirmatory Analyses

For each hypothesis, include the model(s) used, the relevant variables, inference criteria, and model specification.
...
This will contain only any remaining (other) notes that have not been mentioned in any point above. This section will change post-pre-registration to be the Discussion section.
