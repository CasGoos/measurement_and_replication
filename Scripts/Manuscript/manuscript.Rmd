...
Data collection, coding protocol, and planned analyses were all preregistered. The preregistration and supplementary materials can be found on this thesis' OSF page: <https://osf.io/9r8yt/>. Any deviations from the preregistration are explicitly mentioned in the text.
...
<!-- \@ref(sec:measures) didn't work for section corss-reference in the paragraph above-->
...
INSERT H2 FORMULA HERE

The purpose of this analysis was to investigate variability in calculated reliability coefficients within and between replication sets. However, to the author’s knowledge no formal test exists as of the writing of this thesis for testing the significance of within group variance after controlling for between group variance. Instead the intraclass correlation (ICC) coefficient was calculated an indicator of within vs. between variability. Formula XXX shows the formula used to calculate the ICC.

INSERT ICC FORMULA HERE
...
INSERT H3 FORMULA HERE

Where:

INSET f(.) FORMULA HERE
