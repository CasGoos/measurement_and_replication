...
The analysis for H3 related the calculated average reliability coefficients for each replication set to whether the replication was successful when judged at meta-significance level of $alpha <.05$.
