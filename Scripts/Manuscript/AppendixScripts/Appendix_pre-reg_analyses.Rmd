...
The model was the same as that used for the main test of hypothesis 6 (see formula \@ref(eq:H6Main)), only now QMP ratios for each of the five categories were used one at a time for each unique combination of original article and replication protocol QMP.
