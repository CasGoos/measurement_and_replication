...
```{r Hypothesis3MultilevelModelSensitivityAnalyses}
...
# creating the dtaframe for the table <- separate the OMEGA from here???
H3_table_dataframe <- rbind(H3_test_result_int_sensitivity_alpha$table, H3_test_result_main_omega$table, H3_test_result_int_sensitivity_omega$table, H3_test_result_slp_sensitivity_omega$table)


# adding rows to give indication of specific sections (apa_table being awkward)
H3_table_for_printing <- rbind(c("Random-Intercept Multilevel Logistic Model", "", "", "", ""), H3_table_dataframe[(1:2),], c("Omega", "", "", "", ""), c("Logistic Regression Model", "", "", "", ""), H3_table_dataframe[(3:4),], c("Random-Intercept Multilevel Logistic Model", "", "", "", ""), H3_table_dataframe[(5:6),], c("Random-Slope Multilevel Logistic Model", "", "", "", ""), H3_table_dataframe[(7:8),])
...
apa_table(
  ...
  , escape = FALSE, placement= "htp", midrules = c(3, 5, 6, 7, 10, 13))
...
```{r Hypotheses5And6SensitivityAnalyses}
