...
*Explanation*: The information in this dataset was used for analyses relating to QMP ratios among original articles and replication studies. It additionally contains peripheral information about the articles and study in it that were used throughout the analyses and for descriptives. Questions related to modification had 'no modification' as an additional answer option, in case that specific aspect of the measure was explicitly not modified, but might possibly have been applicable, because it was a relevant aspect albeit unmodified. But these operated equivalently to the Not applicable response with respect to the calculation of the QMP ratio. They are included here for future reference.
...
*Explanation*: contains all coded data on the original articles with renamed columns, fixed bad data, restructured to match the ordering of the protocols more eligibly, recoded to be close to suitable for analysis. Additionally, he coded data on 3 measures that did not appear in the replication protocols were removed to allow for easier comparisons between replications and original studies.
...
*Explanation*: contains all coded data on the replications as described in the many labs protocols with renamed columns, fixed bad data, restructured to match the ordering of the protocols more ineligibly, recoded to be close to suitable for analysis.
...
### calculated_reliability_lab_data.csv

*Explanation*: This dataset list contains information on the calculated Cronbach's alpha and the omega reliability coefficient calculated for the responses to the questionnaire items from several of the Many Labs studies, namely those responses encoded in: Data_1.10_clean.csv, data_1.11_clean.csv, data_1.12.3.1_clean.csv, data_1.12.3.2_clean.csv, data_2.10.1_clean.csv, data_2.12.1_clean.csv, data_2.12.2_clean.csv, data_2.12.3_clean.csv, data_2.15_clean.csv, data_2.20_clean.csv, data_2.23_clean.csv, data_3.2.1.1_clean.csv, data_3.2.1.2_clean.csv, data_3.7.2_clean.csv, data_3.8.2_clean.csv, data_5.1.1_clean.csv, data_5.7_clean.csv, data_5.9.1_clean.csv.

*Variables*:

-   **alpha:** Cronbach's alpha calculated for a measure at a particular lab location within a single study/questionnaire as extracted from the Many Labs datasets.

-   **omega.tot:** McDonald's omega for the overarching factor as an estimate of the total reliability of a test calculated for a measure at a particular lab location within a single study/questionnaire as extracted from the Many Labs datasets.

-   **omega.hier:** McDonald's hierarchical omega as the estimate of the general factor saturation of a test (not refered to much in study) calculated for a measure at a particular lab location within a single study/questionnaire as extracted from the Many Labs datasets.

-   **ASE:** Standard error of Cronbach's alpha at a particular lab location, based on formulas 2 & 3 from @duhachekAlphasStandardError2004a.

-   **g:** a short reference to the specific Many Labs replication (and if necessary the particular measure and construct) each alpha was associated with.

-   **coded_data_index:** index of the row in the coded_data_original.csv or coded_data_replication.csv dataset that the indexed measure belongs to.

-   **replication_success:** boolean variable indicating whether or not the measure's related effect was successfully replicated or not when looking at the significance of the meta-analytic p-value.

### FA_Albarracin_2008_math.csv

*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 1 (as stated by order in Table 1. in the Many Labs 5 manuscript) from Many Labs 5 that was checked for reliability and unidimensionality.

*Variables*:

-   **RMSEA:** the RMSEA of a single factor model fitted to the data of this particular lab.

-   **RMSEA_se:** the standard error of the RMSEA of a single factor model fitted to the data of this particular lab.

-   **N_factors:** the number of factors suggested by the parallel analysis on the data of this particular lab.

-   **unidimensional:** the result of our unidimensionality decision rule (RMSEA \<.08 or N_Factors = 1) for this particular lab.

-   **Tau_chisq_diff**: the chi square difference between the Tau restricted single factor model and the non-tau-restricted single factor model each fitted to the data of this particular lab.

-   **Tau_Df_diff**: the degrees of freedom difference between the Tau restricted single factor model and the non-tau-restricted single factor model each fitted to the data of this particular lab.

-   **Tau_p_diff**: the p value of the chi square test between the Tau restricted single factor model and the non-tau-restricted single factor model each fitted to the data of this particular lab.

-   **mean_spec:** the mean of the fully standardized estimated coefficient change for all the five highest mod index freed parameters for the unidimensional model for this particular lab.

-   **err_chisq_diff**: the chi square difference between the single factor model with the five (sequentially) highest mod index freed parameters freed and the non-freed parameters single factor model each fitted to the data of this particular lab.

-   **err_Df_diff**: the degrees of freedom difference between the single factor model with the five (sequentially) highest mod index freed parameters freed and the non-freed parameters single factor model each fitted to the data of this particular lab.

-   **err_p_diff**: the p value of the chi square test between the single factor model with the five (sequentially) highest mod index freed parameters freed and the non-freed parameters single factor model each fitted to the data of this particular lab.

### FA_Albarracin_2008_verb.csv

*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 1 (as ordered in Table 1. in the Many Labs 5 manuscript) from Many Labs 5 that was checked for reliability and unidimensionality.

*Variables*:

-   Same as FA_Albarracin_2008_math.csv

### FA_Anderson_2012_NA.csv

*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 12 (as stated in the Many Labs 2 protocol) from Many Labs 2 that was checked for reliability and unidimensionality.

*Variables*:

-   Same as FA_Albarracin_2008_math.csv

### FA_Anderson_2012_PA.csv
...
### FA_Cacioppo_1983_arg.csv

*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 7 (as stated in the Many Labs 3 protocol) from Many Labs 3 that was checked for reliability and unidimensionality.

*Variables*:

-   Same as FA_Albarracin_2008_math.csv

### FA_Cacioppo_1983_nfc.csv
...
*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 10 (as stated in the Many Labs 1 Proposal_V1.1) from Many Labs 1 that was checked for reliability and unidimensionality.

*Variables*:

-   Same as FA_Albarracin_2008_math.csv

### FA_De_Fruyt_2000.csv

*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 8 (as stated in the Many Labs 3 protocol) from Many Labs 3 that was checked for reliability and unidimensionality.

*Variables*:

-   Same as FA_Albarracin_2008_math.csv

### FA_Giessner_2007.csv

*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 15 (as stated in the Many Labs 2 protocol) from Many Labs 2 that was checked for reliability and unidimensionality.
...
*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 11 (as stated in the Many Labs 1 Proposal_V1.1) from Many Labs 1 that was checked for reliability and unidimensionality.

*Variables*:

-   Same as FA_Albarracin_2008_math.csv

### FA_Monin_2001_most.csv

*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 2 (as stated in the Many Labs 3 protocol) from Many Labs 3 that was checked for reliability and unidimensionality.

*Variables*:

-   Same as FA_Albarracin_2008_math.csv

### FA_Monin_2001_some.csv
...
### FA_Norenzayan_2002.csv

*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 20 (as stated in the Many Labs 2 protocol) from Many Labs 2 that was checked for reliability and unidimensionality.

*Variables*:

-   Same as FA_Albarracin_2008_math.csv

### FA_Nosek_2002_Art.csv

*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 12 (as stated in the Many Labs 1 Proposal_V1.1) from Many Labs 1 that was checked for reliability and unidimensionality.

*Variables*:

-   Same as FA_Albarracin_2008_math.csv

### FA_Nosek_2002_Math.csv
...
*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 7 (as ordered in Table 1. in the Many Labs 5 manuscript) from Many Labs 5 that was checked for reliability and unidimensionality.
...
*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 9 (as ordered in Table 1. in the Many Labs 5 manuscript) from Many Labs 5 that was checked for reliability and unidimensionality.
...
*Explanation*: This dataset describes for each lab location of study several unidimensionality, factor analysis, and Cronbach's Alpha assumptions tests for study 23 (as stated in the Many Labs 2 protocol) from Many Labs 2 that was checked for reliability and unidimensionality.

*Variables*:

-   Same as FA_Albarracin_2008_math.csv

### measure_reliability_data.csv

*Explanation*: For each measure, the mean of the variables from calculated_reliability_lab_data.csv, and the related g variable. Additionally, some data comparing the reported and replicated alpha was added.

*Variables*:

-   **alpha:** Cronbach's alpha calculated for a measure across lab locations as extracted from the Many Labs datasets.

-   **omega.tot:** McDonald's omega for the overarching factor as an estimate of the total reliability of a test calculated for a measure across lab locations as extracted from the Many Labs datasets.

-   **omega.hier:** McDonald's hierarchical omega as the estimate of the general factor saturation of a test (not refered to much in study) calculated for a measure across lab locations as extracted from the Many Labs datasets.

-   **ASE:** Standard error of Cronbach's alpha across lab locations, based on formulas 2 & 3 from @duhachekAlphasStandardError2004a.

-   **tau:** the tau estimate fo heterogeneity as obtained from a meta-analysis of the Cronbach's alpha of the same measure across multiple lab locations.

-   **Qep:** the p-value of the Q test for heterogeneity as obtained from a meta-analysis of the Cronbach's alpha of the same measure across multiple lab locations.

-   **pi.lb & pi.ub:** the lower and upper bound of the meta-analytic prediction interval for the meta-analysis of the Cronbach's alpha of the same measure across multiple lab locations.
...
-   **reported_coefficient**: If present, the reported alpha reliability coefficient in the original article for the measure in this row.

-   **coefficient_difference**: The difference between the reported alpha coefficient and the average coefficient calculated from the replication data (negative values indicate that the reported coefficient is lower than the calculated average)

-   **significance_reported_coefficient**: boolean value indicating whether or not the reported_coeffcient value of a measure is outside the 95% percentile of calculated alpha coefficient score of the same measure.

### QMP_ratio_data.csv

Percentage of measures that have a QMP for each of our QMP items and the number of measures for which they are applicable by both original and replication. The data is organized by QMP item in rows, and the percentages & number of applicable measures being the variables for both original and replication. We also calculated a Phi Coefficient as a correlation between the original QMP and replication QMP being present.

*Variables*:

-   **Practice:** a description of the reporting practice for which we count the percentage of QMPs.

-   **QMP_percentage_original:** the QMP percentage for a particular measurement information in the original studies. This is done by dividing the number of measures for which the relevant measurement information was not available by the total number of measures for which the particular item was applicable.

-   **N_applicable_original:** the number of measures in the original studies for which the measurement item is applicable (factor analytic evidence reporting for single-item measures for instance would not be applicable).

-   **QMP_percentage_replication:** the QMP percentage for a particular measurement information in the replication projects. This is done by dividing the number of measures for which the relevant measurement information was not available by the total number of measures for which the particular item was applicable.

-   **N_applicable_replication:** the number of measures in the replication projects for which the measurement item is applicable (factor analytic evidence reporting for single-item measures for instance would not be applicable).

-   **Phi:** the phi coefficient is a correlation between the original QMP percentage and replication QMP percentage.
